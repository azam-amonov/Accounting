...
public partial class StorageBroker
{
    private static void SeedTransaction(EntityTypeBuilder<Transaction> builder)
    {
        builder.HasData(new Transaction
        {
            ...
            TransactionDate = DateTime.Parse("2024-04-05"),
        ...
        new Transaction
        {
            ...
            TransactionDate = DateTime.Parse("2024-04-02"),
            Comment = "some comment",
            Amount = 5000,
        ...
        new Transaction
        {
            ...
            TransactionDate = DateTime.Parse("2024-04-03"),
            Comment = "some comment",
            Amount = 100,
        ...
        new Transaction
        {
            ...
            TransactionDate = DateTime.Parse("2024-04-10"),
            Comment = "some comment",
            Amount = 500,
        ...
        new Transaction
        {
            ...
            UserId = Guid.Parse("47729a8b-e359-493e-a982-e7c818cd1220"),
            CategoryId = Guid.Parse("ed29109f-27df-43f5-b40d-8b2d12da3738"),
            TransactionDate = DateTime.Parse("2024-03-20"),
            Comment = "some comment",
            Amount = 101,
        ...
        new Transaction
        {
            ...
            UserId = Guid.Parse("47729a8b-e359-493e-a982-e7c818cd1220"),
            CategoryId = Guid.Parse("0ca6c0a4-2a85-4b88-9c42-2fb86334b1ed"),
            TransactionDate = DateTime.Parse("2024-03-02"),
            Comment = "some comment",
            Amount = 40,
        });
    }
